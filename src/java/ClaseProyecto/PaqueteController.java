package ClaseProyecto;

import UMG.Paquete;
import ClaseProyecto.util.JsfUtil;
import ClaseProyecto.util.PaginationHelper;
import ProyectoFinal.PaqueteFacade;
...
public class PaqueteController implements Serializable {
    ...
    @EJB
    private ProyectoFinal.PaqueteFacade ejbFacade;
    ...
    private PaqueteFacade getFacade() {
        return ejbFacade;
    }
